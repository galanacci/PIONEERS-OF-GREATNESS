...
- Founder Origin: three frames render in order, Previous/Next stop at the ends, Left/Right moves between frames, Escape returns to the Founder Hub, and hidden video stops when leaving the frame.
