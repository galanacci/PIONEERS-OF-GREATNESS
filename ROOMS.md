...
- `founder-room`: reached through the versioned GREATNESS POEM introduction. First-time visitors complete the ritual; returning visitors can replay it or enter directly. The room opens on a five-choice interactive Founder Hub. ORIGIN is a three-frame, non-looping cinematic sequence containing the dated London bedroom photograph, the original handwritten GREATNESS poem and the Founder mission film. The former scrolling story remains preserved but hidden until its remaining content has been converted and verified chapter by chapter.
